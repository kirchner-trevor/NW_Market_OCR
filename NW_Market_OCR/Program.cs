...
namespace NW_Market_OCR
{
    class Program
    {
        ...
        // TODO: Use the NWDB site to build a local database of item and location names to help correct the data generated by OCR (https://nwdb.info/db/items/page/2.json / https://nwdb.info/db/item/2hgreataxe_pestilencet5.json)
        ...
        private static bool IsSimilarSetOfMarketListings(List<MarketListing> marketListings)
        {
            ...
            if (previousMarketListings.Count == marketListings.Count)
            {
                ...
                for (int i = 0; i < marketListings.Count; i++)
                {
                    ...
                    matchingDatapoints += previous.Available == current.Available ? 5 : 0;
                    ...
                    matchingDatapoints += previous.Price == current.Price ? 5 : 0;
                }
